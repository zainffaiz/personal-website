...
export function Hero() {
  return (
    <section className="relative pt-24 pb-16 lg:min-h-screen lg:flex lg:items-center lg:pt-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="relative w-36 h-36 rounded-2xl overflow-hidden border border-black/[0.10] shadow-lg">
            <img
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/[0.04] border border-black/[0.10] text-xs font-medium text-muted-foreground mb-6">
          ...
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-[1.1] mb-5">
            Student.<br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-4 text-muted-foreground font-medium">
